 ...
 * https://raw.githubusercontent.com/openlayers/openlayers/main/examples/resources/mapbox-streets-v6-style.js
...
export function createMapboxStreetsV6Style(): StyleLike {
  ...
  function getIcon(iconName: string): Style {
